        ...
        >
          <div className="mail-header">
            ...
            <div className="mail-header-actions">
              ...
              >
                {mail.starred ? <i className="zmdi zmdi-star" /> : <i className="zmdi zmdi-star-outline" />}
              </span>
              <span
                className="icon-btn"
                onClick={() => {
              ...
              >
                {mail.important ? <i className="zmdi zmdi-label-alt" /> : <i className="zmdi zmdi-label-alt-outline" />}
              </span>
            </div>
          </div>
          <hr />
          ...
          <div className="mail-user-info">
            {mail.from.avatar === "" ? (
              ...
              <img className="rounded-circle avatar size-40 mr-4" alt="Alice Freeman" src={mail.from.avatar} />
            )}
            ...
            <Dropdown isOpen={open} className="ml-auto" toggle={this.handleToggle.bind(this)}>
