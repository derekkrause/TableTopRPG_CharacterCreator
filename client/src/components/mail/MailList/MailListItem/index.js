    ...
    <div className="module-list-item mail-cell">
      ...
      <div className="mail-user-info">
        {mail.from.avatar === "" ? (
          ...
          <img className="rounded-circle avatar size-40" alt="Alice Freeman" src={mail.from.avatar} />
        )}
      </div>

      <div
        className="module-list-info ml-2"
        onClick={() => {
          onMailSelect(mail);
        }}
      >
        <div className="module-list-content">
          <div className="mail-user-info">
            ...
            <span
              className="d-inline-block font-weight-semibold text-truncate"
