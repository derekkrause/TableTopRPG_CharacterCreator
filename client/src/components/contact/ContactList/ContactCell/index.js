  ...
  render() {
    ...
    return (
      <div className="contact-item">
        ...
        {thumb === null || thumb === "" ? (
          <div className="rounded-circle size-40 bg-blue text-center text-white mx-1 mx-md-3" style={{ fontSize: 20 }}>
        ...
        <div className="col con-inf-mw-100">
          <p className="mb-0">
            <span className="text-truncate contact-name">{name}</span>
            <span className="d-inline-block toolbar-separator">&nbsp;</span>
            <span className="text-truncate job-title">{designation}</span>
          </p>
        ...
        <div className="col-auto px-1 actions d-none d-sm-flex">
          <Dropdown isOpen={menuState} toggle={this.onContactOptionToggle.bind(this)}>
