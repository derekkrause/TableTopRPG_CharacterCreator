        ...
        <div className="col-lg-4 col-12">
          <ResponsiveContainer width="100%" height={150}>
            <AreaChart data={chartData}>
              <Area type="monotone" dataKey="pv" stroke="rgba(255,255,255,0.5)" fillOpacity={0.8} fill="#3367d6" />
              <Area type="monotone" dataKey="uv" stroke="rgba(255,255,255,0.5)" fillOpacity={0.8} fill="#f3b439" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
