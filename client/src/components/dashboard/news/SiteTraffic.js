  ...
  return (
    <div className="jr-card">
      ...
      <div className="row mb-4">
        <div className="col-3">
          <div className="d-flex align-items-center">
            <span className="border-2 border-green mr-3 rounded-circle p-1 size-60 d-flex align-items-center justify-content-center">
        ...
        <div className="col-3">
          <div className="d-flex align-items-center">
            <span className="border-2 border-red mr-3 rounded-circle p-1 size-60 d-flex align-items-center justify-content-center">
        ...
        <div className="col-3">
          <div className="d-flex align-items-center">
            <span className="border-2 border-primary mr-3 rounded-circle p-1 size-60 d-flex align-items-center justify-content-center">
      ...
      <ResponsiveContainer width="100%" height={350}>
        <LineChart data={siteTrafficData} margin={{ top: 0, right: 0, left: -15, bottom: 0 }}>
          <XAxis dataKey="name" />
          <YAxis />
