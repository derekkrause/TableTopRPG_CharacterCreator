  ...
  return (
    <div className="jr-card p-0 overflow-hidden">
      <div className="jr-card-header mb-0 p-4 bg-grey lighten-4">
        ...
        <p className="sub-heading">Fusce eget dolor id justo luctus commodo vel pharetra nisi. Donec velit libero</p>
      </div>
      ...
      <div className="card-body">
        ...
        <Button size="sm" outline color="primary" className="text-uppercase">
          Get directions
        </Button>
      </div>
    </div>
