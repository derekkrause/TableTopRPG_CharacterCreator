...
const Form = ({ match }) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        <CardBox styleName="col-lg-12" heading={<IntlMessages id="component.selectionControl.checkboxes" />}>
          <Checkboxes />
        </CardBox>

        <CardBox styleName="col-lg-12" heading={<IntlMessages id="component.selectionControl.basicRadio" />}>
          <RadioButtons />
        </CardBox>
        <CardBox styleName="col-lg-12" heading={<IntlMessages id="component.selectionControl.radioBtnGroup" />}>
          <RadioButtonsGroup />
        </CardBox>
      </div>

      <div className="row">
        <CardBox styleName="col-6" heading={<IntlMessages id="component.selects.simple" />}>
          <SimpleSelect />
        </CardBox>
        <CardBox styleName="col-6" heading={<IntlMessages id="component.selects.native" />}>
          <NativeSelect />
        </CardBox>
        <CardBox styleName="col-6" heading={<IntlMessages id="component.selects.multiple" />}>
          <MultipleSelect />
        </CardBox>
        <CardBox styleName="col-6" heading={<IntlMessages id="component.selects.dialog" />}>
          <DialogSelect />
        </CardBox>
      </div>

      <div className="row">
        <CardBox styleName="col-12" heading={<IntlMessages id="component.progress.simpleProgress" />}>
          <SimpleProgress />
        </CardBox>
      </div>

      <div className="row">
        <CardBox styleName="col-4" heading={<IntlMessages id="picker.date.basic" />}>
          <DatePickers />
        </CardBox>

        <CardBox styleName="col-4" heading={<IntlMessages id="picker.date.toggle" />}>
          <DateAndTimePickers />
        </CardBox>

        <CardBox styleName="col-4" heading={<IntlMessages id="picker.date.input" />}>
          <CustomDateTimePicker />
        </CardBox>

        <CardBox styleName="col-6" heading={<IntlMessages id="picker.date.selectDay" />}>
          <TimePickers />
        </CardBox>

        <CardBox styleName="col-6" heading={<IntlMessages id="picker.date.localization" />}>
          <WeekPicker />
        </CardBox>
      </div>

      <div className="row">
        <CardBox styleName="col-4" heading={<IntlMessages id="sidebar.components.alerts" />}>
          <AlertDialog />
        </CardBox>

        <CardBox styleName="col-4" heading="Simple Dialogs">
          <SimpleDialogDemo />
        </CardBox>

        <CardBox styleName="col-4" heading="Form Dialog">
          <FormModals />
        </CardBox>
      </div>
    </div>
