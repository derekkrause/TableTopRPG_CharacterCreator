...
class VenueForm extends React.Component {
  ...
  onChange = e => {
    ...
    this.setState({ [e.target.name]: value }, this.validation);
  };
        ...
        if (!this.state.Id) {
          createVenue(data)
            .then(response => {
              ...
              this.clearStateAfterSuccess();
              this.props.history.push("/app/admin/venues/");
            })
            .catch(err => {
      ...
      <div>
        <div className="app-wrapper">
          <div className="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
            ...
            <Button color="primary" className="jr-btn" onClick={this.toggle} style={{ marginBottom: "1rem" }}>
              Add Venue
            </Button>
          </div>
          <Collapse isOpen={this.state.collapse}>
            <Form className="jr-card">
              ...
              <FormGroup>
                <Label>
                  <Col sm={{ size: 10 }}>
                    <Input type="checkbox" name="Inactive" checked={this.state.Inactive} onChange={this.onChange} />
                    Inactive
                  </Col>
                </Label>
              </FormGroup>
