...
import "../../Event/EventView.css";
import EventCardItemAdmin from "./EventCardItemAdmin";

class EventAdminListView extends Component {
  state = {
    eventDataItem: {},
    eventList: [],
    userList: [],
        ...
        <div className="app-wrapper">
          ...
          <div className="animated slideInUpTiny animation-duration-3">
            {eventCardsList.map(data => (
              <EventCardItemAdmin key={data.id} eventId={data.id} {...this.props} />
            ))}
...
export default EventAdminListView;
