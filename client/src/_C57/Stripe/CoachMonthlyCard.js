...
const monthlyPlan = "plan_DVfh6z2pdyUeD5";
const stripeKey = "pk_test_daPCB26oRZslYkX2F1o28T5p";

const CoachMonthlyCard = ({ styleName, headerStyle, email, fullName, currentUserId, showLoader }) => {
  const onToken = token => {
    showLoader(true);
...
export default CoachMonthlyCard;
