                    ...
                    <React.Fragment key={activity.Id}>
                      <div className="media social-list-line">
                        <div className="bg-white icon-btn user-avatar size-40 z-index-20 align-item-self mr-3">
                          {activity.InitiatorId == this.props.currentUser.id ? (
                            <img className="rounded-circle avatar size-40" src={this.props.currentUser.avatarUrl} />
                          ) : (
                            <img className="rounded-circle avatar size-40" src={activity.AvatarUrl} />
                          )}
                        </div>
                    ...
                    <div className="row">
                      <div className="col-md-12 mb-3">
                        ...
                        <select
                          ...
                          name="responsible"
                          onChange={e => this.props.handleOptionChange(e.target.value)}
                        >
                          <option>Select</option>
                          <option value={this.props.currentUser.id}>Me</option>
                          <option value={this.props.currentAthleteId}>{this.props.activityName}</option>)
                        </select>
                      </div>
                    </div>
                  </React.Fragment>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (this.props.buttonName === "Save") {
                        this.props.updateActivity(this.props.activitiesArray[0].Id);
                      }
                    }}
                    color="blue-grey"
                  >
