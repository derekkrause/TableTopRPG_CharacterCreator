...
namespace Sabio.Web
{
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //     // Following two lines allow us to use a simple plaintext format for our auth cookie - for training only! We'll remove this once we start publishing.

            //CookieName = "auth",
            //TicketDataFormat = new PlaintextSecureDataFormat()
            // });
            ...
            CookieAuthenticationOptions cookieAuthenticationOptions = new CookieAuthenticationOptions();
            {
                ...
                cookieAuthenticationOptions.CookieName = "auth";
